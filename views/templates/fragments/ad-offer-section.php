                                ...
                                <div class="col-lg-4 col-md-12 mb-4">
                                    <div class="card h-100 shadow-lg" id="item-card">
                                        ...
                                        <div class="card-body text-center">
                                            <a href="?action=faireDemandeSoumission&id_service=<?php echo $offre->getIdOffre(); ?>&id_fournisseur=<?php echo $offre->getIdFournisseur(); ?>" class="btn btn-lg">Selectionner</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="flush-collapse<?php echo $index; ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?php echo $index; ?>" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        <a href="?action=faireDemandeSoumission&id_service=<?php echo $offre->getIdOffre(); ?>&id_fournisseur=<?php echo $offre->getIdFournisseur(); ?>" class="btn btn-danger text-end">Selectionner</a>
                                    </div>
                                </div>
                            </div>
                        </div>
