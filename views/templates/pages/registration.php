...
<div class="container" style="background-image: linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url('<?php echo BASE_URL_VIEWS; ?>static/image/snow-plow.jpg'); background-size: cover; background-position: center;">
    <div class="row">
...
<script src="<?php echo BASE_URL_VIEWS; ?>static/scripts/registration-form-user-update.js"></script>
</body>
