    ...
    <header class="p-3 text-white vw-100" style="background-color: #b50303">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/" class="d-flex align-items-center mb-3 mb-lg-0 text-white text-decoration-none me-lg-auto">
                    <div class="d-flex align-items-center bd-highlight ">
                        <img class="mb-4 mt-3 img-fluid img-logo" src="static/image/flocon-black.svg" style="height: 80px; width: 80px;" alt="LOGO">
                ...
                <ul class="d-flex align-items-center nav col-12  col-lg-auto mb-2 mb-md-0 me-5">
                    ...
                    <li><a href="templates/pages/historique-utilisateur.php" class="nav-link px-2 text-white">Mes demandes de service</a></li>
                    <li><a href="/contactPage" class="nav-link px-2 text-white">Nous joindre</a></li>
